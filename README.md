# GSL Elevation Simulator

Static interactive Great Salt Lake elevation simulator.

## Run Locally

Open `index.html` in a browser. It redirects to `gsl-simulator-v14.html`, which contains the full simulator.
